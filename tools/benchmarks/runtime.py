...
def do_dummy_translation(pot_file, po_file):
    ...
    for line in contents.split("\n"):
        ...
        if line.startswith("msgstr "):
            ...
            msgstr = f'msgstr "{last_id} in Polish"'
            ...
            for i, msgstr in enumerate(msgstrs):
                output.append(f'''msgstr[{i}] "{msgstr}\"''')
        ...
        if line.startswith('"Generated-By:'):
            ...
            output.append(
                r'''"Plural-Forms: nplurals=4; plural=(n==1 ? 0 : (n%10>=2 && n%10<=4) && (n%100<12 || n%100>=14) ? 1 : n!=1 && (n%10>=0 && n%10<=1) || (n%10>=5 && n%10<=9) || (n%100>=12 && n%100<=14) ? 2 : 3);\n"'''  # noqa:E501
            )  # noqa
